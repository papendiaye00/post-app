        ...
        <form style={{
          ...
          <Stack direction={"column"} gap={2}>
            <TextField
              ...
              size="small"
              fullWidth
              {...register("nomUtilisateur", { required: "Veuillez saisir un nom", minLength:{ value: 5, message: "Veuillez saisir un nom de plus de 2 caractères" } })}
            />
            <TextField
              id="filled-basic"
            ...
            <TextField
              ...
              type="password"
              fullWidth
              {...register("motDePasseConfirmation", { required: "Veuillez saisir un mot de passe", minLength:{ value: 6, message: "Veuillez saisir un mot de passe de plus de 5caractères" } })}
